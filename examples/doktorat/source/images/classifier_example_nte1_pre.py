from classifier_example_nte_tmpl import nte, fig
from bdp import render_fig
...
# final_add_reg = block(size=p(0.5, 1.2)).align(add[-1].c() + (2.5, 0), prev().c())
# nte += final_add_reg
...
# fig << bus(mux2.n(0.5), p(nte.e()[0] + 2, mux2.n()[1] -3), routedef='|-')
