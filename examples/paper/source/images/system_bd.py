...
ps = block("Processing System", size=p(10,16), margin=p(0.5, 0.5), text_align="nw", dotted=True)()

comp = block(size=p(6,4), node_sep=(4,3))
...
pl = block("Programmable Logic", size=p(32,16), margin=p(0.5, 0.5), text_align="nw", dotted=True).right(ps, 2)()
